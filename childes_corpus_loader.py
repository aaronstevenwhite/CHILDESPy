    ...
    def _process_word(self, word):
        if isinstance(word, tuple):
            ...
            if self.strip_affix:
                ...
                return nltk.util.flatten((stemmed, word[1]))
        else:
            stemmed = word.split('-')
...
if __name__=='__main__':
    ...
    unstemmed_sentences = CHILDESSentences(corpora, sys.argv[1])
    stemmed_sentences = CHILDESStemmedSentences(corpora, sys.argv[1])
    parsed_sentences = CHILDESParsedSentences(corpora, sys.argv[1])
